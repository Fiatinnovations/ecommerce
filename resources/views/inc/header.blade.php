...
<head>
    ...
    <link href="{{ URL::asset('assets/css/reply.css') }}" rel="stylesheet" type="text/css">
    ...
    <script type="text/javascript" src="{{ URL::asset('assets/js/hide/hide.js')}}"></script>
    ...
    <script type="text/javascript" src="{{ URL::asset('js1') }}"></script>--}}
